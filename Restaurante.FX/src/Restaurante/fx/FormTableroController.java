...
public class FormTableroController implements Initializable {
       ...
       ArrayList<Factura> facturas = obtenerFacturas();
        ...
        if (facturas.size() > 0) {
            ...
            String Ultimokey = (fecha.getYear() + fecha.getMonth() + fecha.getDate()) + "-" + 
                    getTextoDia(fecha.getDay()) + " " + fecha.getDate();
    ...
    private void cargarDatosPieChart() {
        ...
        for(Factura factura : facturas) {            
            ...
            for(FacturaDetalle item: detalle) {
                String key = item.getItem().getCategoria().getDescripcion();
    ...
    private ArrayList<Factura> obtenerFacturas() {
        ...
        try {
            ...
            facturas = facturaServicio.getFacturas(fechaInicial, fechaFinal);
    ...
    private String getTextoDia(Integer dia) {
        String textoDia = "";
